...
namespace serenity::scene
{
    ...
    struct Transform
    {
        ...
        interop::TransformBuffer update(const float delta_time, const uint32_t frame_count)
        {
            ...
            const auto transform_buffer = interop::TransformBuffer{

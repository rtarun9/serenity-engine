...
namespace serenity::renderer
{
    ...
    class ShaderCompiler final : public core::SingletonInstance<ShaderCompiler>
    {
      public:
        ...
        // This is because of shader reloading. In the case of re-creating shader for hot reloading, the ignore_error
        // flag can be set so that the function responsible of hot-reloading can use the old pipeline and give warnings
        // to the user. This is to ensure re-loading the app is not required when the new-shader has errors.

...
namespace serenity::renderer::rhi
{
    ...
    class Swapchain
    {
      ...
      public:
        ...
        static constexpr auto SWAPCHAIN_BACK_BUFFER_FORMAT = DXGI_FORMAT_R10G10B10A2_UNORM;
        static constexpr auto SWAPCHAIN_RTV_FORMAT = DXGI_FORMAT_R10G10B10A2_UNORM;

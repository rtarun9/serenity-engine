...
typedef HRESULT(__stdcall *DxcCreateInstance2Proc)(_In_ IMalloc *pMalloc, _In_ REFCLSID rclsid, _In_ REFIID riid,
                                                   _Out_ LPVOID *ppv);
...
extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance(_In_ REFCLSID rclsid, _In_ REFIID riid,
                                                              _Out_ LPVOID *ppv);

extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance2(_In_ IMalloc *pMalloc, _In_ REFCLSID rclsid,
...
struct IDxcCompilerArgs : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE AddArguments(_In_opt_count_(argCount)
    ...
    virtual HRESULT STDMETHODCALLTYPE AddDefines(_In_count_(defineCount) const DxcDefine *pDefines, // Array of defines
...
struct IDxcLibrary : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateBlobFromBlob(_In_ IDxcBlob *pBlob, UINT32 offset, UINT32 length,
                                                         _COM_Outptr_ IDxcBlob **ppResult) = 0;
    virtual HRESULT STDMETHODCALLTYPE CreateBlobFromFile(_In_z_ LPCWSTR pFileName, _In_opt_ UINT32 *codePage,
                                                         _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;
    virtual HRESULT STDMETHODCALLTYPE
    CreateBlobWithEncodingFromPinned(_In_bytecount_(size) LPCVOID pText, UINT32 size, UINT32 codePage,
                                     _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;
    virtual HRESULT STDMETHODCALLTYPE
    CreateBlobWithEncodingOnHeapCopy(_In_bytecount_(size) LPCVOID pText, UINT32 size, UINT32 codePage,
                                     _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;
    virtual HRESULT STDMETHODCALLTYPE CreateBlobWithEncodingOnMalloc(_In_bytecount_(size) LPCVOID pText,
                                                                     IMalloc *pIMalloc, UINT32 size, UINT32 codePage,
                                                                     _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;
    virtual HRESULT STDMETHODCALLTYPE CreateIncludeHandler(_COM_Outptr_ IDxcIncludeHandler **ppResult) = 0;
    virtual HRESULT STDMETHODCALLTYPE CreateStreamFromBlobReadOnly(_In_ IDxcBlob *pBlob,
                                                                   _COM_Outptr_ IStream **ppStream) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetBlobAsUtf8(_In_ IDxcBlob *pBlob,
                                                    _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;

    // Renamed from GetBlobAsUtf16 to GetBlobAsWide
    virtual HRESULT STDMETHODCALLTYPE GetBlobAsWide(_In_ IDxcBlob *pBlob,
                                                    _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;

#ifdef _WIN32
    // Alias to GetBlobAsWide on Win32
    inline HRESULT GetBlobAsUtf16(_In_ IDxcBlob *pBlob, _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
    {
...
struct IDxcCompiler : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE Disassemble(_In_ IDxcBlob *pSource, // Program to disassemble.
...
struct IDxcCompiler2 : public IDxcCompiler
{
    ...
    virtual HRESULT STDMETHODCALLTYPE CompileWithDebug(
        ...
        _Outptr_opt_result_z_ LPWSTR
            *ppDebugBlobName,                   // Suggested file name for debug blob. (Must be CoTaskMemFree()'d!)
...
struct IDxcLinker : public IUnknown
{
  public:
    ...
    virtual HRESULT RegisterLibrary(_In_opt_ LPCWSTR pLibName, // Name of the library.
    ...
    virtual HRESULT STDMETHODCALLTYPE Link(
        ...
        _In_count_(libCount) const LPCWSTR *pLibNames,      // Array of library names to link
        ...
        _In_ UINT32 argCount,                               // Number of arguments
        _COM_Outptr_ IDxcOperationResult **ppResult         // Linker output status, buffer, and errors
        ) = 0;
};
...
struct IDxcUtils : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateBlobFromPinned(_In_bytecount_(size) LPCVOID pData, UINT32 size,
                                                           UINT32 codePage,
                                                           _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;

    // Create blob, taking ownership of memory allocated with supplied allocator.
    // (was: CreateBlobWithEncodingOnMalloc)
    virtual HRESULT STDMETHODCALLTYPE MoveToBlob(_In_bytecount_(size) LPCVOID pData, IMalloc *pIMalloc, UINT32 size,
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateBlob(_In_bytecount_(size) LPCVOID pData, UINT32 size, UINT32 codePage,
                                                 _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;

    // (was: CreateBlobFromFile)
    virtual HRESULT STDMETHODCALLTYPE LoadFile(_In_z_ LPCWSTR pFileName, _In_opt_ UINT32 *pCodePage,
                                               _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;

    virtual HRESULT STDMETHODCALLTYPE CreateReadOnlyStreamFromBlob(_In_ IDxcBlob *pBlob,
                                                                   _COM_Outptr_ IStream **ppStream) = 0;

    // Create default file-based include handler
    virtual HRESULT STDMETHODCALLTYPE CreateDefaultIncludeHandler(_COM_Outptr_ IDxcIncludeHandler **ppResult) = 0;
    ...
    // Renamed from GetBlobAsUtf16 to GetBlobAsWide
    virtual HRESULT STDMETHODCALLTYPE GetBlobAsWide(_In_ IDxcBlob *pBlob,
                                                    _COM_Outptr_ IDxcBlobWide **pBlobEncoding) = 0;

#ifdef _WIN32
    // Alias to GetBlobAsWide on Win32
    inline HRESULT GetBlobAsUtf16(_In_ IDxcBlob *pBlob, _COM_Outptr_ IDxcBlobWide **pBlobEncoding)
    {
        return this->GetBlobAsWide(pBlob, pBlobEncoding);
    }
#endif

    virtual HRESULT STDMETHODCALLTYPE GetDxilContainerPart(_In_ const DxcBuffer *pShader, _In_ UINT32 DxcPart,
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateReflection(_In_ const DxcBuffer *pData, REFIID iid,
    ...
    virtual HRESULT STDMETHODCALLTYPE GetPDBContents(_In_ IDxcBlob *pPDBBlob, _COM_Outptr_ IDxcBlob **ppHash,
...
static_assert(DXC_OUT_NUM_ENUMS == DXC_OUT_LAST + 1, "DXC_OUT_* Enum added and last value not updated.");
...
struct IDxcResult : public IDxcOperationResult
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetOutput(_In_ DXC_OUT_KIND dxcOutKind, _In_ REFIID iid,
...
struct IDxcExtraOutputs : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetOutput(_In_ UINT32 uIndex, _In_ REFIID iid,
                                                _COM_Outptr_opt_result_maybenull_ void **ppvObject,
...
{
    virtual HRESULT STDMETHODCALLTYPE
    Load(_In_ IDxcBlob *pDxilContainerHeader) = 0; // Loads DxilContainer to the builder
    ...
    virtual HRESULT STDMETHODCALLTYPE SerializeContainer(
        _Out_ IDxcOperationResult **ppResult) = 0; // Builds a container of the given container builder state
};
...
struct IDxcOptimizer : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE RunOptimizer(IDxcBlob *pBlob, _In_count_(optionCount) LPCWSTR *ppOptions,
...
struct IDxcPdbUtils : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetArgPair(_In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pName,
...
struct IDxcPdbUtils2 : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetLibraryPDB(_In_ UINT32 uIndex, _COM_Outptr_ IDxcPdbUtils2 **ppOutPdbUtils,
    ...
    virtual HRESULT STDMETHODCALLTYPE GetArgPairCount(_Out_ UINT32 *pCount) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetArgPair(_In_ UINT32 uIndex,
                                                 _COM_Outptr_result_maybenull_ IDxcBlobWide **ppName,
...
CLSID_SCOPE const GUID CLSID_DxcLinker = {0xef6a8087, 0xb0ea, 0x4d56, {0x9e, 0x45, 0xd0, 0x7e, 0x1a, 0x8b, 0x78, 0x6}};
...
CLSID_SCOPE const CLSID CLSID_DxcCompilerArgs = {
    0x3e56ae82, 0x224d, 0x470f, {0xa1, 0xa1, 0xfe, 0x30, 0x16, 0xee, 0x9f, 0x9d}};
